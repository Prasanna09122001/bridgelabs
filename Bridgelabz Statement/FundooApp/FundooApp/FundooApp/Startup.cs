...
namespace FundooApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<INotesManager, NoteManager>();
            services.AddScoped<ILabelRepository, LabelRepository>();
            services.AddScoped<ILabelManager, LabelManager>();
            services.AddScoped<ICollabRepository, CollabRepository>();
            services.AddScoped<ICollabManager, CollabManager>();
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("m1", new OpenApiInfo { Title = "Fundoo App", Version = "m1", Description = "FundooApp" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/m1/swagger.json", "FundooApp");
            });
        }
    }
}
